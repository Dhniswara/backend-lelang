...
use Illuminate\Contracts\Broadcasting\ShouldBroadcastNow; // gunakan Now agar tidak bergantung queue

class LelangSelesaiEvent implements ShouldBroadcastNow
{
